...
# This script downloads all proteins that contain a LysM domain and an M23 domain (in that order)
# Script was generated using this website: https://www.ebi.ac.uk/interpro/result/download/#/protein/UniProt/?ida=b91ad0216b2a0b751f33e047346827902c26cd83|tsv
#
...
BASE_URL = "https://www.ebi.ac.uk:443/interpro/api/protein/UniProt/?ida=b91ad0216b2a0b751f33e047346827902c26cd83&page_size=200"
...
def output_list():
  ...
  while next:
    ...
    for i, item in enumerate(payload["results"]): # this creates the TSV
...
# To save output, open terminal, type the name of this file > output.tsv
